...
const Testimonial: React.FC<Props> = ({
  ...
  const tilesClasses = classNames("tiles-wrap illustration-section-08", pushLeft && "push-left");
  const sectionHeader = {
              ...
              <div className="tiles-item-inner has-shadow">
                <div className="testimonial-item-header">
                  ...
                  <div className="testimonial-item-footer text-xxs tt-u fw-500 mt-32 mb-0 pt-24 has-top-divider">
                    <span className="testimonial-item-name text-color-high">Erika Muliawan</span>
